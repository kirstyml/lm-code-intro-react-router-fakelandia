...
import { ConfessionData, ConfessionResponse, ConfessionChangeHandler, InputTouched } from "../types/confession.types";
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className="confession-form">
                <SubjectInput inputValue={confessionData.subject} handleChange={onChangeHandler} error={subjectError} touched={inputTouched.subject} />
                <ReasonsSelect selectedReason={confessionData.reason} handleChange={onChangeHandler} error={reasonError} touched={inputTouched.reason} />
                <DetailsTextArea detailsText={confessionData.details} handleChange={onChangeHandler} error={detailsError} touched={inputTouched.details} />
