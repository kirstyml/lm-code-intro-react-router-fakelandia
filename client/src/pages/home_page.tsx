...
export const Home: React.FC = () => {
  ...
  const yourMisdemeanours =
    misdemeanours &&
    misdemeanours.filter((misdemeanour) => misdemeanour.citizenId === "YOU!");
    ...
    <div>
      <section>
        ...
        <p>
          ...
          citizens or you can confess your own misdemeanour
        </p>
      </section>
      <section>
        <h2>Statistics</h2>
        ...
        {!isLoading && (
          <p>
            {misdemeanours
              ...
              : "Error loading misdemeanour data"}
          </p>
        )}
