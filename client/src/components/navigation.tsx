...
const Nav: React.FC = () => {
    ...
    return (
        <nav className="nav-bar">
            <button className="nav-menu" onClick={() => setIsExpanded(!isExpanded)}><Menu height={40} width={40} /></button>
            <ul className={isExpanded? "nav-bar__links--expanded" : "nav-bar__links"}>
